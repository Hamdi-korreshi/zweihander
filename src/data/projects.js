export const projects = [
    {
        ...
        slug: 'btc-village',
        title: 'BTC Village',
        excerpt: 'Support network platform with Vue + Django + Postgres',
    ...
    },
    {
        ...
        slug: 'cuda-bfs',
        title: 'GPU Bi-BFS',
        exerpt: 'CUPA + MPI bi-directional BFS implementation with perf notes',
    ...
    },
    {
        ...
        slug: 'cool-compiler',
        title: 'COOL Compiler',
        exerpt: 'The COOL (Classroom Object Orientanted Language) Compiler is a compiler for a Java-like language that can compile to x86-64',
    ...
    },
    {
        ...
        exerpt: 'A showing of how to use a NN and encoding model to create a YouTube similarity aglorithm.',
    ...
    },
    {
        ...
        exerpt: 'A model that uses the Geo spatial splitting model from Facebok and trained it to detect roads.',
